...
import pandas as pd
bag = bagreader('/home/hmruthvik/catkin_ws/src/gnss_ros_driver_/data/obs_moving.bag')
bag.topic_table
def data_csv(bag):
    csvfiles = []
    for t in bag.topics:
...
figure = pd.read_csv("/home/hmruthvik/catkin_ws/src/gnss_ros_driver_/data/obs_moving/gnss.csv")
