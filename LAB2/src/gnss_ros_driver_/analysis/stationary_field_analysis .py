...
import pandas as pd
bag = bagreader('/home/hmruthvik/catkin_ws/src/gnss_ros_driver_/data/clear_stationary.bag')
bag.topic_table
def data_csv(bag):
    csvfiles = []
    for t in bag.topics:
...
figure = pd.read_csv("/home/hmruthvik/catkin_ws/src/gnss_ros_driver_/data/clear_stationary/gnss.csv")
